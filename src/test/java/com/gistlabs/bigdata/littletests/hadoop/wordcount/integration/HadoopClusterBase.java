package com.gistlabs.bigdata.littletests.hadoop.wordcount.integration;
...
public abstract class HadoopClusterBase extends ClusterMapReduceTestCase {
	final static Logger logger = Logger
			.getLogger(com.gistlabs.bigdata.littletests.hadoop.wordcount.integration.HadoopClusterBase.class);
